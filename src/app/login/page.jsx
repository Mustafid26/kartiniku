...
export default function LoginPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (res.ok) {
            ...
            }, 1000); // kasih delay biar pesan "Login berhasil" sempat tampil
        }
    };
    return (
        <div className="flex justify-center items-center min-h-screen bg-white md:bg-gray-100">
            <div className="flex flex-col md:flex-row justify-center items-center md:bg-white md:shadow-lg md:rounded-lg max-w-3xl md:max-w-5xl md:py-[113px] p-4 w-full">
                <div className="image">
                    <img src="/images/login.svg" alt="kartiniku" className="w-96" />
                </div>
