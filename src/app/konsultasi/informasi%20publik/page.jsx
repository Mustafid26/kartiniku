    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row items-center justify-center p-6 rounded-xl gap-8 max-w-5xl mx-auto my-10">
            ...
            <div className="w-full max-w-[220px] sm:max-w-none sm:w-[220px] h-[320px] rounded-xl">
                <img
                    src="/images/konsultasi/informasi-publik.png"
            ...
            <div className="text-left max-w-xl">
                ...
                <p className="text-gray-700 mb-4">
                    Menyediakan layanan informasi publik dan menerima aspirasi,
                    ide, serta gagasan dari masyarakat untuk mendukung
                    pembangunan kota.
                </p>
                ...
                <div className="mb-4">
                    ...
                    <ul className="list-disc list-inside text-gray-700 space-y-1">
                        ...
                        <li>Penyampaian aspirasi dan ide</li>
                    </ul>
                </div>
